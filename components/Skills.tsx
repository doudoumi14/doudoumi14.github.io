...
function CompetencyCard({ group }: { group: SkillGroup }) {
  return (
    <div className="rounded-2xl border border-line bg-card p-6 transition duration-300 hover:border-accent/40 hover:bg-card-hover">
  ...
  return (
    <section id="skills" className="mx-auto max-w-5xl px-6 py-20">
      <div className="reveal">
        <p className="text-sm font-semibold tracking-wider text-accent uppercase">Capability</p>
